...
public class IAPKey
{
    public const string PACK1 = "weapon_sound_tracks_1";
    public const string PACK2 = "weapon_sound_tracks_2";
    public const string PACK3 = "weapon_sound_tracks_3";
    public const string PACK4 = "weapon_sound_tracks_4";
    public const string PACK5 = "weapon_sound_tracks_5";
    public const string PACK6 = "weapon_sound_tracks_6";

    public const string PACK1_REGISTER = "weapon_sound_tracks_register_1";
    public const string PACK2_REGISTER = "weapon_sound_tracks_register_2";
    public const string PACK3_REGISTER = "weapon_sound_tracks_register_3";
    public const string PACK4_REGISTER = "weapon_sound_tracks_register_4";
    public const string PACK5_REGISTER = "weapon_sound_tracks_register_5";
}
